...
/***/ "./node_modules/_webpack@4.35.0@webpack/buildin/module.js":
/*!***********************************!*\
...
!function (t, e) {
  if ("object" == ( false ? undefined : _typeof(exports)) && "object" == ( false ? undefined : _typeof(module))) module.exports = e();else if (true) !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_FACTORY__ = (e),
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));else { var r, o; }
}(global, function () {
  return function (t) {
    var e = {};
    ...
    function s(t, e) {
      ...
      return s == l && (o = new r(u.text, u.correctLevel), n.push({
        text: u.text,
        ...
        for (var _e = 0; _e < r; _e++) {
          for (var _n = 0; _n < r; _n++) {
            var _s = Math.ceil((_n + 1) * l) - Math.floor(_n * l),
                a = Math.ceil((_e + 1) * l) - Math.floor(_e * l),
                f = i({
              row: _e,
              col: _n,
              count: r,
            ...
            o.fillStyle = t.modules[_e][_n] ? f : u.background, o.fillRect(Math.round(_n * l), Math.round(_e * h), _s, a);
          }
        }
      }(o, e);
    }
    ...
    function r(t, e) {
      this.typeNumber = -1, this.errorCorrectLevel = e, this.modules = null, this.moduleCount = 0, this.dataCache = null, this.rsBlocks = null, this.totalDataCount = -1, this.data = t, this.utf8bytes = function (t) {
        for (var e = [], r = 0; r < t.length; r++) {
          for (var n = o(t.charCodeAt(r)), u = 0; u < n.length; u++) {
            e.push(n[u]);
          }
        }
    ...
    r.prototype = {
      ...
      setupPositionProbePattern: function setupPositionProbePattern(t, e) {
        for (var o = -1; o <= 7; o++) {
          if (!(t + o <= -1 || this.moduleCount <= t + o)) for (var r = -1; r <= 7; r++) {
            e + r <= -1 || this.moduleCount <= e + r || (this.modules[t + o][e + r] = 0 <= o && o <= 6 && (0 == r || 6 == r) || 0 <= r && r <= 6 && (0 == o || 6 == o) || 2 <= o && o <= 4 && 2 <= r && r <= 4);
          }
        }
      },
      ...
      setupPositionAdjustPattern: function setupPositionAdjustPattern() {
        for (var t = c.getPatternPosition(this.typeNumber), e = 0; e < t.length; e++) {
          for (var o = 0; o < t.length; o++) {
            var r = t[e],
                n = t[o];
            if (null == this.modules[r][n]) for (var u = -2; u <= 2; u++) {
              for (var i = -2; i <= 2; i++) {
                this.modules[r + u][n + i] = -2 == u || 2 == u || -2 == i || 2 == i || 0 == u && 0 == i;
              }
            }
          }
        }
      ...
      setupTypeNumber: function setupTypeNumber(t) {
        for (var e = c.getBCHTypeNumber(this.typeNumber), o = 0; o < 18; o++) {
          var r = !t && 1 == (e >> o & 1);
      ...
      setupTypeInfo: function setupTypeInfo(t, e) {
        for (var o = n[this.errorCorrectLevel] << 3 | e, r = c.getBCHTypeInfo(o), u = 0; u < 15; u++) {
          var i = !t && 1 == (r >> u & 1);
      ...
      createData: function createData() {
        ...
        for (var o = 0, n = this.utf8bytes.length; o < n; o++) {
        ...
        for (; !(t.length >= 8 * this.totalDataCount || (t.put(r.PAD0, 8), t.length >= 8 * this.totalDataCount));) {
          t.put(r.PAD1, 8);
        }
      ...
      createBytes: function createBytes(t) {
        for (var e = 0, o = 0, r = 0, n = this.rsBlock.length / 3, u = new Array(), i = 0; i < n; i++) {
          for (var s = this.rsBlock[3 * i + 0], l = this.rsBlock[3 * i + 1], h = this.rsBlock[3 * i + 2], a = 0; a < s; a++) {
            u.push([h, l]);
          }
        }
        ...
        for (var f = new Array(u.length), g = new Array(u.length), d = 0; d < u.length; d++) {
          var m = u[d][0],
              v = u[d][1] - m;
          o = Math.max(o, m), r = Math.max(r, v), f[d] = new Array(m);
        ...
        for (i = 0; i < o; i++) {
          for (d = 0; d < u.length; d++) {
            i < f[d].length && (P[L++] = f[d][i]);
          }
        }

        for (i = 0; i < r; i++) {
          for (d = 0; d < u.length; d++) {
            i < g[d].length && (P[L++] = g[d][i]);
          }
        }
      ...
      mapData: function mapData(t, e) {
        for (var o = -1, r = this.moduleCount - 1, n = 7, u = 0, i = this.moduleCount - 1; i > 0; i -= 2) {
          for (6 == i && i--;;) {
            for (var s = 0; s < 2; s++) {
              if (null == this.modules[r][i - s]) {
                var l = !1;
                u < t.length && (l = 1 == (t[u] >>> n & 1)), c.getMask(e, r, i - s) && (l = !l), this.modules[r][i - s] = l, -1 == --n && (u++, n = 7);
              }
            }
    ...
    for (var n = [1, 0, 3, 2], u = 0, i = 1, s = 2, l = 3, h = 4, a = 5, f = 6, g = 7, c = {
      ...
      getErrorCorrectPolynomial: function getErrorCorrectPolynomial(t) {
        for (var e = new p([1], 0), o = 0; o < t; o++) {
          e = e.multiply(new p([1, d.gexp(o)], 0));
        }
      ...
      getLostPoint: function getLostPoint(t) {
        for (var e = t.getModuleCount(), o = 0, r = 0, n = 0; n < e; n++) {
          for (var u = 0, i = t.modules[n][0], s = 0; s < e; s++) {
            ...
            if (s < e - 6 && l && !t.modules[n][s + 1] && t.modules[n][s + 2] && t.modules[n][s + 3] && t.modules[n][s + 4] && !t.modules[n][s + 5] && t.modules[n][s + 6] && (s < e - 10 ? t.modules[n][s + 7] && t.modules[n][s + 8] && t.modules[n][s + 9] && t.modules[n][s + 10] && (o += 40) : s > 3 && t.modules[n][s - 1] && t.modules[n][s - 2] && t.modules[n][s - 3] && t.modules[n][s - 4] && (o += 40)), n < e - 1 && s < e - 1) {
              var h = 0;
              l && h++, t.modules[n + 1][s] && h++, t.modules[n][s + 1] && h++, t.modules[n + 1][s + 1] && h++, 0 != h && 4 != h || (o += 3);
            }

            i ^ l ? u++ : (i = l, u >= 5 && (o += 3 + u - 5), u = 1), l && r++;
          }
        }
        ...
        for (s = 0; s < e; s++) {
          for (u = 0, i = t.modules[0][s], n = 0; n < e; n++) {
            l = t.modules[n][s];
            n < e - 6 && l && !t.modules[n + 1][s] && t.modules[n + 2][s] && t.modules[n + 3][s] && t.modules[n + 4][s] && !t.modules[n + 5][s] && t.modules[n + 6][s] && (n < e - 10 ? t.modules[n + 7][s] && t.modules[n + 8][s] && t.modules[n + 9][s] && t.modules[n + 10][s] && (o += 40) : n > 3 && t.modules[n - 1][s] && t.modules[n - 2][s] && t.modules[n - 3][s] && t.modules[n - 4][s] && (o += 40)), i ^ l ? u++ : (i = l, u >= 5 && (o += 3 + u - 5), u = 1);
          }
        }
    ...
    p.prototype = {
      ...
      multiply: function multiply(t) {
        for (var e = new Array(this.getLength() + t.getLength() - 1), o = 0; o < this.getLength(); o++) {
          for (var r = 0; r < t.getLength(); r++) {
            e[o + r] ^= d.gexp(d.glog(this.get(o)) + d.glog(t.get(r)));
          }
        }
      ...
      mod: function mod(t) {
        ...
        for (; r.length >= o;) {
          var u = d.glog(r[0]) - d.glog(t.get(0));

          for (n = 0; n < t.getLength(); n++) {
            r[n] ^= d.gexp(d.glog(t.get(n)) + u);
          }
    ...
    r.prototype.getRightType = function () {
      for (var t = 1; t < 41; t++) {
        ...
        if (this.utf8bytes.length + i < r || 40 == t) {
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../node_modules/_webpack@4.35.0@webpack/buildin/module.js */ "./node_modules/_webpack@4.35.0@webpack/buildin/module.js")(module)))
